            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form method ="POST" action = "{{ URL::to('protocols') }}" autocomplete="off">
                            @csrf
                            <div class="card-body">
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                                    <label for="inputName">Наименование</label>
                                    <input type="text" class="form-control" id="inputName" name = "name" spellcheck="true">
                                ...
                                <div class="form-group {{ $errors->has('patient_problems') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "patient_problems" id = "patient_problems" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('anamnesis_vitae') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "anamnesis_vitae" id = "anamnesis_vitae" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('anamnesis_morbi') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "anamnesis_morbi" id = "anamnesis_morbi" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('bite') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "bite" id = "bite" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('objective_data') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "objective_data" id = "objective_data" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('xray_data') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "xray_data" id = "xray_data" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('diagnosis') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "diagnosis" id = "diagnosis" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('treatment_plan') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "treatment_plan" id = "treatment_plan" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('work_done') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "work_done" id = "work_done" spellcheck="true" required></textarea>
                                ...
                                <div class="form-group {{ $errors->has('recommendations') ? 'has-error' : ''}}">
                                    ...
                                    <textarea class="form-control" rows="5" name = "recommendations" id = "recommendations" spellcheck="true" required></textarea>
