...
@section('title', '| Информация пациента')
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <p class="text-muted text-center">ЧТО НАПИШЕМ...</p>
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link" href="#activity" data-toggle="tab">Визиты</a></li>
                                <li class="nav-item"><a class="nav-link active show" href="#timeline" data-toggle="tab">Лечения</a></li>
