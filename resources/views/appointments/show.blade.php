                        ...
                        <div class="card-body box-profile">
                            <dl>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-4"><dt>Пол</dt>
                                        <dd>{{$appointment->patient->gender}}
                                        </dd>
                                    </div>
                                    <div class="col-md-4"><dt>Адрес</dt>
                                        <dd>
                                            @if(isset($appointment->patient->address))--}}
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <dt>Состояние слизистой</dt>
                                        <dd>
                                            @if(isset($appointment->mucous_membrane))
                                                {{$appointment->mucous_membrane}}
                                            @else
                                                Нет данных
                                            @endif
                                        </dd>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <dt>Описание результатов лечения</dt>
                                        <dd>
